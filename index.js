...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchContainer = __webpack_require__(195);
	...
	var reducers = (0, _redux.combineReducers)({
	  ...
	  notes: _reducer4.default
	});
	
	var localState = JSON.parse(localStorage.getItem('hn.state') || '{}');
	
	var store = (0, _redux.createStore)(reducers, localState, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), window.devToolsExtension ? window.devToolsExtension() : function (f) {
	  return f;
	}));
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-3' },
	            _react2.default.createElement(_HistoryContainer2.default, null)
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'col-sm-9' },
	          ...
	          _react2.default.createElement(_NoteFormContainer2.default, null)
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    searchChange: function searchChange(term) {
	      dispatch(_actions2.default.updateSearch(term));
	    },
	    addToHistory: function addToHistory(term) {
	      dispatch(_actions2.default.addToHistory(term));
	    },
	    doSearch: function doSearch(term) {
	      dispatch(_actions2.default.doSearch(term));
	    },
	    togglePopover: function togglePopover(verseRef) {
	      dispatch(_actions2.default.togglePopover(verseRef));
	    },
	    removeNote: function removeNote(verseRef, index) {
	      dispatch(_actions4.default.removeNote(verseRef, index));
	    }
	  };
	};
	
	var SearchContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_SearchBox2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (_ref) {
	  ...
	  var handleVerseClick = function handleVerseClick(ref) {
	    togglePopover(ref);
	  };
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_Passage2.default, { passage: passage,
	...
	var _Passage = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Search = function Search(props) {
	  return _react2.default.createElement(
	    "div",
	    { className: "panel panel-default col-sm-9" },
	    _react2.default.createElement(
	      "div",
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            "label",
	            { "for": "passage-search", className: "control-label" },
	            "Search"
	          ),
	          _react2.default.createElement(
	            "div",
	...
	Search.propTypes = {
	  searchTermChange: _react.PropTypes.func.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Passage = function (_React$Component) {
	  ...
	  function Passage() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Passage).apply(this, arguments));
	  }
	  ...
	  _createClass(Passage, [{
	    ...
	    value: function render() {
	      ...
	      var removeNote = this.props.removeNote;
	      return _react2.default.createElement(
	        'div',
	        null,
	        passage.map(function (verse, key) {
	...
	Passage.propTypes = {
	  passage: _react.PropTypes.array
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Verse = function Verse(props) {
	  ...
	  if (props.popoverRef === props.content.verseRef) {
	    popover = _react2.default.createElement(_PopoverContainer2.default, null);
	  }
	
	  var classes = ['col-sm-9 verse'];
	  ...
	  var notes = props.formatting.notes[props.content.verseRef] || [];
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: classes.join(' '), onClick: handleClick },
	      _react2.default.createElement(
	        'sup',
	        null,
	        props.content.verse_nr
	      ),
	      props.content.verse,
	      popover
	    ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actions3 = __webpack_require__(196);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    togglePopover: function togglePopover(verseRef) {
	      dispatch(_actions4.default.togglePopover(verseRef));
	    },
	    toggleNoteForm: function toggleNoteForm() {
	      dispatch(_actions2.default.toggleNoteForm());
	    },
	    setNewNoteRef: function setNewNoteRef(verseRef) {
	      dispatch(_actions2.default.setNewNoteRef(verseRef));
	    },
	    toggleHighlight: function toggleHighlight(verseRef) {
	      dispatch(_actions2.default.toggleHighlight(verseRef));
	    },
	    toggleCircle: function toggleCircle(verseRef) {
	      dispatch(_actions2.default.toggleCircle(verseRef));
	    },
	    toggleUnderline: function toggleUnderline(verseRef) {
	      dispatch(_actions2.default.toggleUnderline(verseRef));
	    }
	  };
	};
	
	var PopoverContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_Popover2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Popover = function (_React$Component) {
	  ...
	  function Popover() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Popover)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.actions = {
	      note: function note() {
	        _this.props.setNewNoteRef(_this.props.popoverRef);
	        _this.props.toggleNoteForm();
	      },
	      highlight: function highlight(e) {
	        _this.props.toggleHighlight(_this.props.popoverRef);
	      },
	      circle: function circle(e) {
	        _this.props.toggleCircle(_this.props.popoverRef);
	      },
	      underline: function underline(e) {
	        _this.props.toggleUnderline(_this.props.popoverRef);
	      }
	    }, _this.handleKeypress = function (e) {
	      if (e.keyCode === keyCodes.esc) _this.props.togglePopover('');else if (e.keyCode === keyCodes.n) _this.doAction('note');else if (e.keyCode === keyCodes.h) _this.doAction('highlight');else if (e.keyCode === keyCodes.c) _this.doAction('circle');else if (e.keyCode === keyCodes.u) _this.doAction('underline');
	    }, _this.handleClick = function (e) {
	      e.nativeEvent.stopImmediatePropagation();
	      e.stopPropagation();
	    }, _this.handleClickOutside = function (e) {
	      _this.props.togglePopover('');
	    }, _this.doAction = function (action, e) {
	      _this.actions[action](e);
	      _this.props.togglePopover('');
	  ...
	  _createClass(Popover, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'popover', onClick: this.handleClick },
	        _react2.default.createElement(
	          'i',
	          { className: 'popover__icon material-icons',
	            onClick: this.doAction.bind(null, 'note') },
	          'note_add'
	        ),
	        _react2.default.createElement('span', { className: 'popover__spacer' }),
	        _react2.default.createElement(
	          'i',
	          { className: 'popover__icon material-icons',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Note = function Note(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      "div",
	      { className: "panel panel-default col-sm-3 col-xs-12 pull-right" },
	      _react2.default.createElement(
	        "div",
	        { className: "panel-body note" },
	        _react2.default.createElement(
	          "a",
	          { href: "javascript:;", className: "note__remove",
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    ...
	    doSearch: function doSearch() {
	      dispatch(_actions2.default.doSearch());
	    },
	    deleteItem: function deleteItem(index) {
	      dispatch(_actions2.default.removeFromHistory(index));
	    }
	  };
	};
	
	var HistoryContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_History2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var History = function History(_ref) {
	  ...
	  var handleClick = function handleClick(term) {
	    updateSearch(term);
	    doSearch();
	  };
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'ul',
	      { className: 'list-unstyled history' },
	      history.map(function (term, i) {
	        return _react2.default.createElement(
	          'li',
	          { key: i, className: 'history__item' },
	          _react2.default.createElement(
	            'a',
	            { href: 'javascript:;', onClick: handleClick.bind(null, term) },
	            ' ',
	            term,
	            ' '
	          ),
	          _react2.default.createElement(
	            'a',
	            { href: 'javascript:;', onClick: handleDelete.bind(null, i),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    addNote: function addNote(note, verseRef) {
	      dispatch(_actions2.default.addNote(note, verseRef));
	    },
	    toggleNoteForm: function toggleNoteForm() {
	      dispatch(_actions2.default.toggleNoteForm());
	    }
	...
	var NoteFormContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_NoteFormBox2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteFormBox = function NoteFormBox(props) {
	  var form = null;
	  if (props.showNoteForm) {
	    form = _react2.default.createElement(_NoteForm2.default, props);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoteForm = function NoteForm(_ref) {
	  var verseRef = _ref.verseRef;
	  var showNoteForm = _ref.showNoteForm;
	  var addNote = _ref.addNote;
	  var toggleNoteForm = _ref.toggleNoteForm;
	
	  var componentState = { noteText: '' };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function searchReducer() {
	  ...
	  switch (action.type) {
	    case _actions.types.UPDATE_SEARCH_TERM:
	      return _extends({}, state, {
	        searchTerm: action.term
	      });
	
	    case _actions.types.ADD_TO_HISTORY:
	      return _extends({}, state, {
	        history: [action.term].concat(_toConsumableArray(state.history))
	      });
	
	    case _actions.types.REMOVE_FROM_HISTORY:
	      return _extends({}, state, {
	        history: [].concat(_toConsumableArray(state.history.slice(0, action.index)), _toConsumableArray(state.history.slice(action.index + 1)))
	      });
	
	    case _actions.types.SET_LOADING:
	      return _extends({}, state, {
	        loading: action.loading
	      });
	
	    case _actions.types.DO_SEARCH:
	      return _extends({}, state, {
	        loading: true
	      });
	
	    case _actions.types.UPDATE_TEXT:
	      return _extends({}, state, {
	        text: action.text
	      });
	
	    case _actions.types.TOGGLE_POPOVER:
	      return _extends({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function notesReducer() {
	  ...
	  switch (action.type) {
	    case _actions.types.TOGGLE_NOTE_FORM:
	      return _extends({}, state, {
	        showNoteForm: !state.showNoteForm
	      });
	
	    case _actions.types.SET_NEW_NOTE_REF:
	      return _extends({}, state, {
	        newNoteRef: action.verseRef
	      });
	
	    case _actions.types.ADD_NOTE:
	      if (state.notesByRef[action.verseRef]) {
	        //if a note already exists, push the new note into that verse's list of notes
	        return _extends({}, state, {
	          notesByRef: _extends({}, state.notesByRef, _defineProperty({}, action.verseRef, [].concat(_toConsumableArray(state.notesByRef[action.verseRef]), [action.note])))
	        });
	      } else {
	        //otherwise add the verse to the refs list and create a new note list for the verse
	        return _extends({}, state, {
	          noteRefs: [].concat(_toConsumableArray(state.noteRefs), [action.verseRef]),
	          notesByRef: _extends({}, state.notesByRef, _defineProperty({}, action.verseRef, [action.note]))
	        });
	      }
	
	    case _actions.types.REMOVE_NOTE:
	      {
	        var updatedNotesByRef = [].concat(_toConsumableArray(state.notesByRef[action.verseRef].slice(0, action.index)), _toConsumableArray(state.notesByRef[action.verseRef].slice(action.index + 1)));
	        var updatedNoteRefs = [].concat(_toConsumableArray(state.noteRefs));
	        if (!updatedNotesByRef.length) {
	          var refIndex = state.noteRefs.indexOf(action.verseRef);
	          updatedNoteRefs = [].concat(_toConsumableArray(state.noteRefs.slice(0, refIndex)), _toConsumableArray(state.noteRefs.slice(refIndex + 1)));
	        }
	        return _extends({}, state, {
	    ...
	    case _actions.types.TOGGLE_HIGHLIGHT:
	      var index = state.highlights.indexOf(action.verseRef);
	      if (index === -1) {
	        return _extends({}, state, {
	          highlights: [].concat(_toConsumableArray(state.highlights), [action.verseRef])
	        });
	      } else {
	        return _extends({}, state, {
	          highlights: [].concat(_toConsumableArray(state.highlights.slice(0, index)), _toConsumableArray(state.highlights.slice(index + 1)))
	        });
	      }
	
	    case _actions.types.TOGGLE_CIRCLE:
	      var index = state.circles.indexOf(action.verseRef);
	      if (index === -1) {
	        return _extends({}, state, {
	          circles: [].concat(_toConsumableArray(state.circles), [action.verseRef])
	        });
	      } else {
	        return _extends({}, state, {
	          circles: [].concat(_toConsumableArray(state.circles.slice(0, index)), _toConsumableArray(state.circles.slice(index + 1)))
	        });
	      }
	
	    case _actions.types.TOGGLE_UNDERLINE:
	      var index = state.underlines.indexOf(action.verseRef);
	      if (index === -1) {
	        return _extends({}, state, {
	          underlines: [].concat(_toConsumableArray(state.underlines), [action.verseRef])
	        });
	      } else {
	        return _extends({}, state, {
	          underlines: [].concat(_toConsumableArray(state.underlines.slice(0, index)), _toConsumableArray(state.underlines.slice(index + 1)))
	        });
	      }
